...
<GMA3 DataVersion="0.0.1">
  <BaseInput Name="TimeMAtricks_Menu" H="0" W="700" AlignmentH="Center" AlignmentV="Center" Focus="InitialFocus" CanCoexistWithModal="Yes" BlockClickThru="Yes" SuppressOverlayAutoClose="Yes" HideFocusFrame="Yes" CloseOnEscape="Yes">
    ...
    <TitleBar Name="TitleBar" Anchors="0,0">
      ...
      <WarningInfoButton Name="TitleWarningButton" Anchors="0,0,1,0" Font="Regular32" BackColor="Global.AlertText" Texture="corner3" />
    </TitleBar>
    ...
    <DialogFrame Name="Main" Anchors="0,1">
      ...
      <UILayoutGrid Name="PluginButtons" Anchors="0,1" Padding="10,10,10,10">
        ...
        <Button Name="PlOff" Text="Plugin Off" Anchors="0,0" Texture="corner5" Focus="Never" TextShadow="Yes" Font="Medium20" Clicked=":plugin_off" />
        <Button Name="PlOn" Text="Plugin On" Anchors="1,0" Texture="corner10" Focus="Never" TextShadow="Yes" Font="Medium20" Clicked=":plugin_on" />
      </UILayoutGrid>
      ...
      <UILayoutGrid Name="Master" Anchors="0,3" Padding="10,10,10,">
        ...
        <Button Name="MstTiming" Text="Timing Master" Anchors="0,0" Texture="corner5" Focus="Never" Clicked=":set_master" />
        <Button Name="MstSpeed" Text="Speed Master" Anchors="1,0" Texture="corner10" Focus="Never" Clicked=":set_master" />
        <LineEdit Name="Master ID" Message="Obj Number" Anchors="2,0" Padding="0,0,10,0" Texture="corner15" Icon="master" IconAlignmentH="Right" IconAlignmentV="Center" TextChanged=":text_master" KeyDown=":key_down" FocusGet=":LineEditSelectAll" FocusLost=":LineEditDeselect" VKPluginName="TextInputNumOnly" Filter="0123456789" OnWrongChar=":show_warning" MaxTextLength="2" />
      </UILayoutGrid>
      ...
      <UILayoutGrid Name="MatricksPrefix" Anchors="0,4" Padding="10,5,170,0">
        ...
        <CheckBox Name="Matricks Prefix" Text="Matricks Prefix" TextAlignmentH="Left" Anchors="0,0" Texture="corner5" Focus="Never" Clicked=":prefix_toggle" />
        <LineEdit Name="Matricks Prefix Name" Message="Prefix (e.g: tm_)" Anchors="1,0" Texture="corner10" KeyDown=":key_down" FocusGet=":LineEditSelectAll" FocusLost=":LineEditDeselect" />
      </UILayoutGrid>
      ...
      <UILayoutGrid Name="Fade" Anchors="0,7" Padding="10,0,10,10">
        ...
        <Button Name="FadeLess" Text="Fade Less" Anchors="0,0" Texture="corner5" Focus="Never" TextShadow="Yes" Font="Medium20" BackColor="ProgLayer.Fade" Clicked=":fade_change" MouseDownHold=":fade_toggle" />
        <Button Name="FadeMore" Text="Fade More" Anchors="1,0" Texture="corner10" Focus="Never" TextShadow="Yes" Font="Medium20" BackColor="ProgLayer.Delay" Clicked=":fade_change" MouseDownHold=":fade_toggle" />
      </UILayoutGrid>
      ...
      <UILayoutGrid Name="Scale" Anchors="0,9" Padding="10,0,10,10">
        ...
        <Button Name="1/2" Anchors="0,0" Texture="corner5" Icon="ExecuteHalfSpeed84" Focus="Never" Clicked=":rate_change" />
        ...
        <Button Name="2" Anchors="2,0" Texture="corner10" Icon="ExecuteDoubleSpeed84" Focus="Never" Clicked="dRate" Clicked=":rate_change" />

        <Button Name="Reset" Anchors="1,0" Icon="ExecuteRate120" Focus="Never" Margin="80,45,80,0" Texture="corner15" Clicked=":rate_change" />
      </UILayoutGrid>
      ...
      <UILayoutGrid Name="BottomButtons" Anchors="0,10" Padding="0,0,0,0">
        ...
        <Button Name="Apply" Text="Apply" Anchors="0,0" Texture="corner5" Focus="CanHaveFocus" TextShadow="Yes" Font="Medium20" Clicked=":apply_changes" />
        <Button Name="Close" Text="Close" Anchors="1,0" Texture="corner10" Focus="CanHaveFocus" TextShadow="Yes" Font="Medium20" Clicked=":close_menu" />
      </UILayoutGrid>
    </BaseInput>
  </GMA3>
]]
